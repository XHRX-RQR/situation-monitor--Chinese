...
// DeepLX API 配置
// 生产环境应从环境变量读取
const DEEPLX_API_URL = import.meta.env.VITE_DEEPLX_API_URL || 'https://api.deeplx.org/YOUR_KEY_HERE/translate';
const DEEPLX_API_KEY = import.meta.env.VITE_DEEPLX_API_KEY || 'YOUR_KEY_HERE';
